PROJECT_NAME := Pulumi Azuredevops Extensions Resource Provider

PACK             := azuredevops-extensions
PACKDIR          := sdk
PROJECT          := github.com/totvs/pulumi-azuredevops-extensions
NODE_MODULE_NAME := @pulumi/azuredevops-extensions
NUGET_PKG_NAME   := Pulumi.AzuredevopsExtensions
...
SCHEMA_FILE     := provider/cmd/pulumi-resource-azuredevops-extensions/schema.json
