...
export class BuildFolder extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BuildFolder {
        return new BuildFolder(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azuredevops-extensions:index:BuildFolder';
    ...
    constructor(name: string, args: BuildFolderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BuildFolder.__pulumiType, name, inputs, opts);
    }
}
