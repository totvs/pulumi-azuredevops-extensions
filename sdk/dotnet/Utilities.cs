...
namespace Pulumi.AzureDevopsExtensions
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AzureDevopsExtensions.version.txt");
    ...
    internal sealed class AzureDevopsExtensionsResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AzureDevopsExtensionsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
